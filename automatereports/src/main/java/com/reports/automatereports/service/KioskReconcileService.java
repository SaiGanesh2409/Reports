...
@Service
public class KioskReconcileService {

    private static final String SQL_FILE_PATH = "queries/KioskReconcileReport.sql";
    ...
    public void executeQueryAndExportToExcel() throws IOException {
        ...
        String excelFilePath = "src/main/resources/reports/KioskReconcileReport_" + date + ".xlsx";
